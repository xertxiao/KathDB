...
class ListRankSelector:
    ...
    def _rank_chunk(self, root, candidates):
        ...
        prompt = (
            ...
            "put its candidate values in the prompt or compare by equality in code. Code "
            "takes over a judgement only when it is exact (e.g., equality on a stored "
            "column), never by guessing from words in free text. State "
